...
.field private static final SECONDARY_STORAGE_DIRECTORY:Ljava/io/File; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/os/Environment;->SECONDARY_STORAGE_DIRECTORY:Ljava/io/File;
...
.method public static getRealExternalStorageDirectory()Ljava/io/File;
    ...
    .prologue
    .line 968
    invoke-static {}, Landroid/os/Environment;->isEmmcAsExternalStorageDirectory()Z
...
.method public static getRealExternalStorageState()Ljava/lang/String;
    ...
    .line 1002
    .local v2, storage:Ljava/io/File;
    ...
    .line 1005
    .end local v2           #storage:Ljava/io/File;
    :goto_0
    return-object v3
    ...
    const-string v5, "Failed to read real external storage state; assuming REMOVED: "
...
.method public static getRealInternalStorageDirectory()Ljava/io/File;
    .locals 1
...
.method public static getRealInternalStorageState()Ljava/lang/String;
    .locals 6
    ...
    .line 984
    .local v0, mountService:Landroid/os/storage/IMountService;
    invoke-static {}, Landroid/os/Environment;->getRealInternalStorageDirectory()Ljava/io/File;
    ...
    const-string v5, "Failed to real real internal storage state; assuming REMOVED: "
...
.method public static getSecondaryStorageDirectory()Ljava/io/File;
    ...
    .prologue
    .line 871
    sget-object v0, Landroid/os/Environment;->SECONDARY_STORAGE_DIRECTORY:Ljava/io/File;
...
.method public static hasExternalStorageMounted()Z
    .locals 8
    ...
    .line 934
    .local v1, list:[Landroid/os/storage/StorageVolume;
    if-nez v1, :cond_0
    ...
    .line 946
    .end local v0           #i:I
    .end local v1           #list:[Landroid/os/storage/StorageVolume;
    ...
    .restart local v1       #list:[Landroid/os/storage/StorageVolume;
    ...
    const-string v7, "Failed to get external storage mounted state"
...
.method public static isEmmcAsExternalStorageDirectory()Z
    .locals 2
    ...
    .line 920
    const-string/jumbo v1, "persist.sys.emmcsdcard.enabled"
