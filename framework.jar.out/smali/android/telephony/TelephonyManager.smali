...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/telephony/TelephonyManager$Operators;
    }
.end annotation
...
.field public static final BB_TYPE_DSDS_DC:I = 0x3

.field public static final BB_TYPE_DSDS_SC:I = 0x2

.field public static final BB_TYPE_DSSS:I = 0x1

.field public static final BB_TYPE_SINGLE:I = 0x0
...
.field private static final COUNTRY_INDEX:I = 0x0
...
.field private static final LANGUAGE_INDEX:I = 0x1

.field private static final NAMELONG_INDEX:I = 0x3

.field private static final NAMESHORT_INDEX:I = 0x2
...
.field protected static sModemConfig:[Ljava/lang/String;

.field private static sOperatorSim1:Ljava/lang/String;

.field private static sOperatorSim2:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sget-object v3, Landroid/telephony/TelephonyManager;->multiSimConfig:Ljava/lang/String;
    ...
    invoke-static {}, Landroid/telephony/TelephonyManager;->isDSDSEnabled()Z
    ...
    .line 94
    const-string/jumbo v0, "ril.basewin.modem.config"
    ...
    sput-object v0, Landroid/telephony/TelephonyManager;->sModemConfig:[Ljava/lang/String;
    ...
    const-string/jumbo v2, "nameshort"

    aput-object v2, v0, v1

    const/4 v1, 0x3

    const-string/jumbo v2, "namelong"

    aput-object v2, v0, v1

    sput-object v0, Landroid/telephony/TelephonyManager;->PROJECTION:[Ljava/lang/String;

    .line 2139
    sput-object v4, Landroid/telephony/TelephonyManager;->sOperatorSim1:Ljava/lang/String;

    .line 2140
    sput-object v4, Landroid/telephony/TelephonyManager;->sOperatorSim2:Ljava/lang/String;
...
.method public static DynSwitchModem(I)Z
    .locals 1
    .parameter "switchToWhat"
...
.method public static getBaseBandType()I
    .locals 2

    .prologue
    .line 2192
    const-string/jumbo v0, "ril.basewin.baseband"
...
.method public static getDefaultNetworkMode()[I
    ...
    .line 2213
    .local v1, modeConfig:[Ljava/lang/String;
    array-length v3, v1
...
.method public static getDsn(Landroid/content/Context;)Ljava/lang/String;
    .locals 2
    .parameter "context"
    ...
    const-string v1, "device_sn_number"
...
.method public static getExtraModem()Ljava/lang/String;
    .locals 1
...
.method public static getNetworkMode(I)I
    ...
    .line 2201
    .local v0, modeConfig:[Ljava/lang/String;
    if-ltz p0, :cond_0
...
.method private static getOperatorAlphaFromDatabase(Ljava/lang/String;Landroid/content/Context;Z)Ljava/lang/String;
    ...
    .line 1589
    .local v7, alphaShort:Ljava/lang/String;
    const/4 v6, 0x0

    .line 1590
    .local v6, alphaLong:Ljava/lang/String;
    ...
    .line 1591
    .local v10, sysLanguage:Ljava/lang/String;
    ...
    .line 1593
    .local v9, sysCountry:Ljava/lang/String;
    const-string/jumbo v3, "numeric=? AND country=? AND language=?"
    ...
    sget-object v1, Landroid/telephony/TelephonyManager$Operators;->CONTENT_URI:Landroid/net/Uri;

    sget-object v2, Landroid/telephony/TelephonyManager;->PROJECTION:[Ljava/lang/String;
    ...
    .line 1642
    .end local v6           #alphaLong:Ljava/lang/String;
    :goto_0
    return-object v6

    .restart local v6       #alphaLong:Ljava/lang/String;
    :cond_8
    move-object v6, v7
...
.method public static getOperatorAlphaLong(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    .parameter "numeric"
    .parameter "context"
    .parameter "defValue"
    ...
    invoke-static {p0, p1, v1}, Landroid/telephony/TelephonyManager;->getOperatorAlphaFromDatabase(Ljava/lang/String;Landroid/content/Context;Z)Ljava/lang/String;
...
.method public static getOperatorAlphaShort(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    .parameter "numeric"
    .parameter "context"
    .parameter "defValue"
    ...
    .line 1554
    .local v0, alphaShort:Ljava/lang/String;
    if-nez v0, :cond_0
...
.method public static getPsn(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "pcba_sn_number"
...
.method public static getSimDisplayName(ILandroid/content/Context;)Ljava/lang/String;
    .locals 1
    .parameter "simId"
    .parameter "context"
...
.method public static isDSDSEnabled()Z
    ...
    .prologue
    .line 2234
    invoke-static {}, Landroid/telephony/TelephonyManager;->getBaseBandType()I
...
.method public static isPoliceModel(Landroid/content/Context;)Z
    .locals 1
    .parameter "context"
...
.method public static isSimBgColorEnabled()Z
    .locals 2

    .prologue
    .line 2136
    const-string/jumbo v0, "ui.multi.sim.bgcolor.enable"
...
.method public static isSimSelectionEnabled()Z
    .locals 2

    .prologue
    .line 2131
    const-string/jumbo v0, "ui.multi.sim.selection.prompt"
...
.method public static isSupportDataDsda()Z
    .locals 2
    ...
    .line 2375
    invoke-static {}, Landroid/telephony/TelephonyManager;->isUseGSMModem()Z

    move-result v1

    if-nez v1, :cond_0

    invoke-static {}, Landroid/telephony/TelephonyManager;->isUseCdmaModem()Z
    ...
    :cond_0
    const-string/jumbo v1, "persist.data.dsda"
...
.method public static isSupportDynSwitchModem()Z
    .locals 2

    .prologue
    .line 2346
    const-string/jumbo v0, "ril.basewin.dyn.switch.modem"
...
.method public static isUseCdmaModem()Z
    .locals 1

    .prologue
    .line 2310
    invoke-static {}, Landroid/telephony/TelephonyManager;->isUseQcom6085()Z
...
.method public static isUseCdmaModem(I)Z
    .locals 1
    .parameter "subscription"

    .prologue
    .line 2314
    invoke-static {p0}, Landroid/telephony/TelephonyManager;->isUseQcom6085(I)Z
...
.method public static isUseExtraModem()Z
    .locals 1
...
.method public static isUseExtraModem(I)Z
    .locals 1
    .parameter "subscription"
...
.method public static isUseGSMModem()Z
    .locals 1

    .prologue
    .line 2285
    invoke-static {}, Landroid/telephony/TelephonyManager;->isUseMT6252()Z
...
.method public static isUseGSMModem(I)Z
    .locals 1
    .parameter "subscription"

    .prologue
    .line 2290
    invoke-static {p0}, Landroid/telephony/TelephonyManager;->isUseMT6252(I)Z
...
.method public static isUseMT6252()Z
    .locals 1
...
.method public static isUseMT6252(I)Z
    .locals 1
    .parameter "subscription"
...
.method public static isUseQcom6085()Z
    .locals 2

    .prologue
    .line 2296
    invoke-static {}, Landroid/telephony/TelephonyManager;->getExtraModem()Ljava/lang/String;

    move-result-object v0

    const-string v1, "QCOM6085"
...
.method public static isUseQcom6085(I)Z
    .locals 1
    .parameter "subscription"
...
.method public static isUseTDModem()Z
    .locals 1

    .prologue
    .line 2336
    invoke-static {}, Landroid/telephony/TelephonyManager;->isUseTDSC8802G()Z
...
.method public static isUseTDModem(I)Z
    .locals 1
    .parameter "subscription"

    .prologue
    .line 2341
    invoke-static {p0}, Landroid/telephony/TelephonyManager;->isUseTDSC8802G(I)Z
...
.method public static isUseTDSC8802G()Z
    .locals 2
...
.method public static isUseTDSC8802G(I)Z
    .locals 1
    .parameter "subscription"
...
.method public static rebuildNumeric(Ljava/lang/String;)Ljava/lang/String;
    .locals 5
    .parameter "numeric"
    ...
    invoke-static {v3}, Lcom/android/internal/telephony/MccTable;->smallestDigitsMccForMnc(I)I
...
.method public static setSafetyUSBMode(I)Z
    .locals 3
    .parameter "turnOn"
    ...
    .line 2363
    const-string/jumbo v0, "sys.safety.usb.mode.support"
...
.method public static setTDModemNotSleep(I)Z
    .locals 1
    .parameter "notSleep"
